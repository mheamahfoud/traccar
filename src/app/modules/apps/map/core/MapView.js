...
import usePersistedState, { savePersistedState } from '../../../../../_metronic/helpers/common/util/usePersistedState';
import prepareMapImages , {mapImages}  from './preloadImages';
...
const MapView = ({ children }) => {
  ...
  useEffect(() => {
    ...
    switcher.updateStyles(styles, 'osm');
