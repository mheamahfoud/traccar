...
import { MaintenanceStatus } from './_models'
import { useQueryRequest } from './QueryRequestProvider'


const QueryResponseContext = createResponseContext<MaintenanceStatus>(initialQueryResponse)
const QueryResponseProvider: FC<WithChildren> = ({ children }) => {
  ...
  const {
    ...
    `${QUERIES.SETTING_Maintenace_STATUS_LIST_VALUE}-${query}`,
    () => {
