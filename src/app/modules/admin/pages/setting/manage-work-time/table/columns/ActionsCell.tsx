...
import {EditWorkTimePath} from '../../../routes/RoutesNames'
import {useIntl} from 'react-intl'

import { WorkingTIme } from '../../core/_models'
...
const ActionsCell: FC<Props> = ({data}) => {
  ...
  const handleEdit = () => {
    ...
    navigate(EditWorkTimePath, {state: data})
  }
  ...
  return (
    <>
      ...
      {/* begin::Menu */}
      <MenuActionWrapper>
       {currentUser?.roles.includes('edit_working_time') &&  <MenuActionItem title={intl.formatMessage({id: 'edit'})} onCLick={handleEdit} />}
