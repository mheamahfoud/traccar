...
import {EditDepartmentPath} from '../../../routes/RoutesNames'
...
const ActionsCell: FC<Props> = ({data}) => {
  ...
  const handleEdit = () => {
    ...
    navigate(EditDepartmentPath, {state: data})
  }
  ...
  return (
    <>
      ...
      {/* begin::Menu */}
      <MenuActionWrapper>
      {currentUser?.roles.includes('edit_department') &&  <MenuActionItem title={intl.formatMessage({id: 'edit'})} onCLick={handleEdit} />}
