...
import { initialReasonCancelModel } from '../core/_models';
import { roleSchema } from './validationForm';
import { create } from '../core/_requests';
import { useNotification } from '../../../../../../../_metronic/hooks/useNotification';
import { useNavigate } from 'react-router-dom';
import { ListReasonCarOutServicePath } from '../../routes/RoutesNames';
        ...
        <KTCard>
            ...
            <KTCardBody className='py-4'>
                <Formik
                    ...
                    initialValues={initialReasonCancelModel}
                    ...
                    onSubmit={async (values, { setSubmitting }) => {
                        ...
                        try {
                            ...
                            if(res.result=='success'){
                                navigate(ListReasonCarOutServicePath)
                            }
