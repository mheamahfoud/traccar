...
import {EditCityPath} from '../../../routes/RoutesNames'
...
const ActionsCell: FC<Props> = ({data}) => {
  ...
  const handleEdit = () => {
    ...
    navigate(EditCityPath, {state: data})
  }
  ...
  return (
    <>
      ...
      {/* begin::Menu */}
      <MenuActionWrapper>
      {currentUser?.roles.includes('edit_city') &&   <MenuActionItem title={intl.formatMessage({id: 'edit'})} onCLick={handleEdit} />}
