...
const ActionsCell: FC<Props> = ({data}) => {
  ...
  const handleEdit = () => {
    ...
    navigate(EditReasonCancelPath, {state: data})
  }
  ...
  return (
    <>
      ...
      {/* begin::Menu */}
      <MenuActionWrapper>
     { currentUser?.roles.includes('edit_reason_cancel')  &&  <MenuActionItem title={intl.formatMessage({id: 'edit'})} onCLick={handleEdit} />}
