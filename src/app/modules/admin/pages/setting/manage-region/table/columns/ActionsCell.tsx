...
import {EditRegionPath} from '../../../routes/RoutesNames'
...
const ActionsCell: FC<Props> = ({data}) => {
  ...
  const handleEdit = () => {
    ...
    navigate(EditRegionPath, {state: data})
  }
  ...
  return (
    <>
      ...
      {/* begin::Menu */}
      <MenuActionWrapper>
      {currentUser?.roles.includes('edit_region') &&  <MenuActionItem title={intl.formatMessage({id: 'edit'})} onCLick={handleEdit} />}
