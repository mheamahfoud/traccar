...
import { getGroupListByRegion, getRegiosList, getShiftList, getVehicleList } from '../../../core/commonRequests'
import { WorkingDayType } from '../core/_models'
import { getRegionsBytype } from '../core/_requests'
...
const Form: FC = () => {
  ...
  return (
    <>
      {!enableApi && <form className='form' onSubmit={handleSubmit} noValidate>
        {/* begin::Scroll */}
        <div className='d-flex flex-column scroll-y me-n7 pe-7'>
          <div className='row'>
            ...
            {(values['type'] == 1 || !values['type']) && <div className='col-md-6 col-sm-12'>
              <FormikSelectInput
