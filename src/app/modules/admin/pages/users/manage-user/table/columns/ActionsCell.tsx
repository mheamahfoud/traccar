...
import {AddPermissionUserPath, EditUserPath} from '../../../routes/RoutesNames'
...
const handlePermission = ()=>{
  ...
  return (
    <>
      ...
      {/* begin::Menu */}
      <MenuActionWrapper>
      {currentUser?.roles.includes('edit_user')  &&   <MenuActionItem title={intl.formatMessage({id: 'edit'})} onCLick={handleEdit} />}
        {currentUser?.roles.includes('assign_permission_user')  &&   <MenuActionItem title={intl.formatMessage({id: 'permission'})} onCLick={handlePermission} />}
