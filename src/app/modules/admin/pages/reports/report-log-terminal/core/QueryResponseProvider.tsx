...
import { LogTerminal} from './_models'
import { useQueryRequest } from './QueryRequestProvider'


const QueryResponseContext = createResponseContext<LogTerminal>(initialQueryResponse)
const QueryResponseProvider: FC<WithChildren> = ({ children }) => {
  ...
  const {
    ...
    `${QUERIES.MANAGE_LOG_TERMINAL_REPORT_LIST_VALUES}-${query}`,
    () => {
