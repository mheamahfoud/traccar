...
import { CarOutService} from './_models'
import { useQueryRequest } from './QueryRequestProvider'


const QueryResponseContext = createResponseContext<CarOutService>(initialQueryResponse)
const QueryResponseProvider: FC<WithChildren> = ({ children }) => {
  ...
  const {
    ...
    `${QUERIES.MANAGE_CAR_OUT_SERVICE_REPORT_LIST_VALUES}-${query}`,
    () => {
