...
import { LogPath} from './_models'
import { useQueryRequest } from './QueryRequestProvider'


const QueryResponseContext = createResponseContext<LogPath>(initialQueryResponse)
const QueryResponseProvider: FC<WithChildren> = ({ children }) => {
  ...
  const {
    ...
    `${QUERIES.MANAGE_LOG_PATH_REPORT_LIST_VALUES}-${query}`,
    () => {
