...
import { initialAddCamera } from '../core/_models';
import { roleSchema } from './validationForm';
import { addCameraToVehicle } from '../core/_requests';
        ...
        <KTCard>
            ...
            <KTCardBody className='py-4'>
                <Formik
                    ...
                    initialValues={initialAddCamera}
                    initialStatus={{ edit: false }}
                    onSubmit={async (values, { setSubmitting }) => {
                        setSubmitting(true)
                        try {
                           const res: ResponeApiCheck = await addCameraToVehicle(values);
