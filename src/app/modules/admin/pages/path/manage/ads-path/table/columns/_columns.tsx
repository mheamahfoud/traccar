...
const columnsTable :  ReadonlyArray<Column<Ads>> = [
  ...
  {
    Header: (props) => <CustomHeader<AdsPath>  tableProps={props} title={<Localize value='name' />} className='min-w-125px' />,
    accessor: 'name',
  },
  {
    Header: (props) => <CustomHeader<AdsPath>  tableProps={props} title={<Localize value='period' />} className='min-w-125px' />,
    accessor: 'period',
  },
  {
    Header: (props) => (
